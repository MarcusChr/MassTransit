...
public class MessageDataFormatter<T> : IMessagePackFormatter<MessageData<T>>
{
    public void Serialize(ref MessagePackWriter writer, MessageData<T> value, MessagePackSerializerOptions options)
    {
        ...
        var innerFormatter = options.Resolver.GetFormatterWithVerify<SystemTextMessageDataReference>();
